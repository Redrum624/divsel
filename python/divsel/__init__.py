...
(Maximal Marginal Relevance). This package wraps a native Rust core with zero-copy numpy
bindings: :func:`gist_select` returns the selected row indices, :func:`gist_select_full`
the full result dict (objective value, diversity, winning threshold and stage).
"""
